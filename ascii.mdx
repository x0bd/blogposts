...
## From p5.js to Blazingly Fast Request

I've been playing around with [p5.js]() for creating generative sketches, and the urge to experiment with ASCII art struck. I built one using p5.js, but the perfomance was abysmal. This led me down the path of building one with Rust, and let me tell you, it was a revelation. The Rust version was blazingly fast, super lightweight, and surprisingly straightforward to create.

Now, let's dive in and see how can you build your own terminal ASCII art generator in Rust!

## Setting Up The Project

### 1. Create a new Rust Project

Open your terminal and run cargo `cargo init <project_name>`. Replace `<project_name>` with your desired name (e.g., `rascii`). This command creates the basic structure for your Rust project.
...
The `main` function is the entry point of our program. Here, it calls the `get_image` function with the path to your image ("morty.png") and a scaling factor of 2. You can adjust the scaling factor to control the detail level of the resulting ASCII art.
...
<CustomImage
	src="https://github.com/x0bd/blogposts/blob/master/images/rick.png?raw=true"
	alt="inkdrop by Takuya Matsumaya"
/>
...
I hope this tutorial empowered you to explore the world of Rust for creative coding endeavors. There's a whole universe of possibilities waiting to be explored. Happy coding!
